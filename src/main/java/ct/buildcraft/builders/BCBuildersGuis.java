...
public class BCBuildersGuis {
    ...
    public static final RegistryObject<MenuType<ContainerArchitectTable>> MENU_ARCHITECT_TABLE = MENUS.register("architect_menu", () -> new MenuType<>(new BCContainerFactory<>(ContainerArchitectTable::new)));
