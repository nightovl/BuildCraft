...
public class BCBuildersGuis {
    ...
    public static final RegistryObject<MenuType<ContainerArchitectTable>> MENU_ARCHITECT_TABLE = MENUS.register("architect_menu", () -> IForgeMenuType.create(new BCContainerFactory<>(ContainerArchitectTable::new)));
    public static final RegistryObject<MenuType<ContainerBuilder>> MENU_BUILDER = MENUS.register("builder_menu", () -> new MenuType<>(ContainerBuilder::new));
    public static final RegistryObject<MenuType<ContainerElectronicLibrary>> MENU_ELIBRARY = MENUS.register("elibrary_menu", () -> new MenuType<>(new BCContainerFactory<>(ContainerElectronicLibrary::new)));
